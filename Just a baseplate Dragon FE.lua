game.Players.LocalPlayer.Character["PogoStick"].Handle.Mesh:Destroy()--Nike Shoebox Costume
...
att2.Rotation = Vector3.new(-90, 0, 0) --BrownCharmerHair
...
prt.Anchored=true
prt.CFrame=cframe
--local msh=mesh("SpecialMesh",prt,"FileMesh","rbxassetid://0",vt(0,0,0),vt(x1,y1,z1))
--rbxassetid://4770560
...
prt.Anchored=true
prt.CFrame=cframe
msh=mesh("SpecialMesh",prt,"FileMesh","rbxassetid://0",vt(0,0,0),vt(x1,y1,z1))
game:GetService("Debris"):AddItem(prt,5)
coroutine.resume(coroutine.create(function(Part,Mesh) 
for i=0,1,delay do
swait()
...
game:GetService("Players").LocalPlayer.Character["PogoStick"].Handle.att1_Handle.Parent = Handle
Handle.att1_Handle.Rotation = Vector3.new(-0,90,0)
Handle.att1_Handle.Position = Vector3.new(-0,0,2.5)
...
game:GetService("Players").LocalPlayer.Character["PlaneModel"].Handle.att1_Handle.Parent = Handle2
Handle2.att1_Handle.Rotation = Vector3.new(-0,0,90)
Handle2.att1_Handle.Position = Vector3.new(-0,0,2.5)
...
Mesh = New("SpecialMesh",Gear2,"Mesh",{Offset = Vector3.new(0, 0, -1),Scale = Vector3.new(25, 25, 25),MeshId = "rbxassetid://0",MeshType = Enum.MeshType.FileMesh,})
...
Mesh = New("SpecialMesh",Gear,"Mesh",{Offset = Vector3.new(0, 0, -1),Scale = Vector3.new(25, 25, 25),MeshId = "rbxassetid://0",MeshType = Enum.MeshType.FileMesh,})
...
Mesh = New("SpecialMesh",DragonHead,"Mesh",{Scale = Vector3.new(5, 5, 5),MeshId = "rbxassetid://0",MeshType = Enum.MeshType.FileMesh,})
...
game:GetService("Players").LocalPlayer.Character["VANS_Umbrella"].Handle.att1_Handle.Parent = DragonHead
...
moosick.SoundId = "rbxassetid://7023635858"
 --142653441, 175067863
...
partasdeff.Texture = "rbxassetid://0"
...
--Damagefunc(torsy,"",0,0,0,"Normal",RootPart,0,1)
end
    for i=0,1,0.1 do
        swait()
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
